...
$scope.registration = {selectedImage : ''};
...
.controller('DishDetailController',
        ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicModal', '$timeout', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast',
        function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicModal, $timeout,$ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
    ...
    $scope.deleteFavorite = function(index) {
        ...
        confirmPopup.then(function(response) {
            if (response) {
				...
				$ionicPlatform.ready(function () {	$cordovaVibration.vibrate(100); });
            } else {
